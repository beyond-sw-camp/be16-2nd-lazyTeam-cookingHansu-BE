...
//        MultiValueMap을 통해 자동으로 form-data형식으로 body 조립 가능
    ...
    public CommonProfileDto getProfile(String token){
        ...
        // 카카오 프로필을 공통 프로필로 변환
        KakaoProfileDto kakaoProfile = response.getBody();
        return kakaoProfile != null ? kakaoProfile.toCommonProfile() : null;
    }
    ...
    public CommonProfileDto getKakaoProfile(String token) {
